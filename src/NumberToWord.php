<?php
/**
 * A class conver number to English words
 * Example 100 to one hunderd
 * The accept range is PHP's max integer
 * Accept decimal, and negative number.
 * 
 * If there is any error, it will throw exception with message.
 * 
 * Original function was from Karl
